                        ...
                        <div class="ibox-content">
                            ...
                            <table class="footable table table-stripped toggle-arrow-tiny" data-page-size="15">
                                ...
                                <tbody>
                                    ...
                                    $query = "select * from user INNER JOIN `level` ON user.id_level = level.id_level;";
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                <div class="btn-group">
                                                    ...
                                                    <button class="btn-white btn btn-xs"><a href="edit_user_view.php?id=<?php echo $data['id'] ?>">Edit</a></button>
                                                    <button class="btn-white btn btn-xs"><a href="../action/action_delete_user.php?id=<?php echo $data['id'] ?>">Delete</a></button>
