        ...
        <div id="page-wrapper" class="gray-bg">
            <div class="row border-bottom white-bg">
                <nav class="navbar navbar-expand-lg navbar-static-top" role="navigation">
                    ...
                    <a href="#" class="navbar-brand">Manage Size</a>
                            ...
                            <table class="footable table table-stripped toggle-arrow-tiny" data-page-size="15">
                                <thead>
                                    <tr>
                                        ...
                                        <th data-toggle="true">ID Size</th>
                                        <th data-hide="phone">Ukuran Size</th>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                <div class="btn-group">
                                                    ...
                                                    <button class="btn-white btn btn-xs"><a href="edit_size_view.php?id=<?php echo $data['id_size'] ?>">Edit</a></button>
                                                    <button class="btn-white btn btn-xs"><a href="../action/action_hapus_size.php?id=<?php echo $data['id_size'] ?>">Delete</a></button>
                                ...
                                <tfoot>
                                    <tr>
                                        <td colspan="6">
                                            ...
                                            <!-- Modal -->
                                            <form action="../action/action_size.php" method="post">
                                                <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title" id="exampleModalLabel">Input Size Baru</h5>
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="form-group">
                                                                    <input type="text" class="form-control" placeholder="Nama Tipe" required="" name="namasize" />
                                                                </div>
                                                            </div>
