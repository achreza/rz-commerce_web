        ...
        <div id="page-wrapper" class="gray-bg">
            <div class="row border-bottom white-bg">
                <nav class="navbar navbar-expand-lg navbar-static-top" role="navigation">
                    ...
                    <a href="#" class="navbar-brand">List barang</a>
                        ...
                        <div class="ibox-content">
                            ...
                            <table class="footable table table-stripped toggle-arrow-tiny" data-page-size="15">
                                ...
                                <tbody>
                                    ...
                                    $query = "select * from barang inner join tipe where barang.id_tipe = tipe.id_tipe";
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                <div class="btn-group">
                                                    <button class="btn-white btn btn-xs"><a href="product_detail_view.php?id=<?php echo $data['id'] ?>">View</a></button>
                                                    <button class="btn-white btn btn-xs"><a href="edit_barang_view.php?id=<?php echo $data['id'] ?>">Edit</a></button>
                                                    <button class="btn-white btn btn-xs"><a href="../action/action_delete_barang.php?id=<?php echo $data['id'] ?>">Delete</a></button>
