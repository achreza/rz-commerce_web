                ...
                <div class="col-lg-12">
                    <div class="ibox ">
                        ...
                        <div class="ibox-content">
                            <form method="POST" action="../action/action_update_user.php?id=<?php echo $id ?>" enctype="multipart/form-data">
                                <div class="form-group  row"><label class="col-sm-2 col-form-label">Nama User</label>

                                    <div class="col-sm-10"><input type="text" class="form-control" name="namauser" value="<?php echo $barang['nama'] ?>"></div>
                                </div>
                                ...
                                <div class="form-group  row"><label class="col-sm-2 col-form-label">Username</label>
                                    ...
                                    <div class="col-sm-10"><input type="text" class="form-control" name="username" value="<?php echo $barang['username'] ?>"></div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                <div class="form-group  row"><label class="col-sm-2 col-form-label">Password</label>

                                    <div class="col-sm-10"><input type="text" class="form-control" name="password" value="<?php echo $barang['password'] ?>"></div>
                                </div>
                                <div class=" hr-line-dashed"></div>
