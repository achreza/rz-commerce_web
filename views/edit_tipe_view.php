                ...
                <div class="col-lg-12">
                    <div class="ibox ">
                        <div class="ibox-title">
                            <h5>Ganti Data Tipe</h5>

                        </div>
                        <?php
                        include '../config/koneksi.php';
                        $query2 = "select * from tipe where id_tipe = '$id'";
                        ...
                        <div class="ibox-content">
                            <form method="POST" action="../action/action_update_tipe.php?id=<?php echo $id ?>">
                                <div class="form-group  row"><label class="col-sm-2 col-form-label">Nama Tipe</label>

                                    <div class="col-sm-10"><input type="text" class="form-control" name="namatipe" value="<?php echo $barang['nama_tipe'] ?>"></div>
                                </div>
